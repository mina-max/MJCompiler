...
public class VarDeclListExpr extends VarDeclList {

    private VarDeclList VarDeclList;
    private VarDeclSingle VarDeclSingle;

    public VarDeclListExpr (VarDeclList VarDeclList, VarDeclSingle VarDeclSingle) {
